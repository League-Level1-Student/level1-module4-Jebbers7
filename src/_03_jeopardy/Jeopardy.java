...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel = createHeader("Sea Animals");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonPressed == firstButton) {
			askQuestion("What type of animal are dolphins?", "Mammals", 200);
			firstButton.setText("");
		}
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("Where are spiders most commonly found?", "Australia", 400);
		...
		// Clear the text on the button that was pressed (set the button text to nothing)
			...
			askQuestion("What is the most poisonous octopus?", "Blue-ringed octopus", 600);
			thirdButton.setText("");
		}
		else if(buttonPressed == fourthButton) {
			askQuestion("What is the fastest species of bird?", "Peregrine falcon", 800);
			fourthButton.setText("");
		}
		else if(buttonPressed == fifthButton) {
			askQuestion("How much of the ocean is it estimated that we have not explored?", "Over 97%", 1000);
			fifthButton.setText("");
		}
	}
